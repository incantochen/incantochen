...
export default async function OrdersPage() {
  ...
  // §6：查詢失敗 ≠ 查無資料——DB 暫時性故障不可誤渲染成「目前沒有訂單」。
  // throw 交給 account/error.tsx 顯示「系統忙碌」。
      ...
      {orders.map((order) => (
        ...
        >
          <div className="flex items-center justify-between md:contents">
            <span className="text-primary underline underline-offset-2 md:order-1">
              {order.order_no}
            </span>
            <span
          ...
          <span className="text-ash md:order-2">
