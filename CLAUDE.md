...
- **目前階段**：M-1／M0／M1 ✅ 全數完成（T17／T48／T55／T56 暫緩）→ **M2 進行中**（完成／待修清單見 `docs/tasks.csv`）→ M3 → M4 → M5。**開發流程全貌見 [`docs/dev-process.md`](docs/dev-process.md)；人工救援程序見 [`docs/ops-runbook.md`](docs/ops-runbook.md)。**
