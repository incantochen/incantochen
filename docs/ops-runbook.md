...
修完 T107 後，剩餘的非正常狀況全部收斂為兩類：**設計上的一天延遲**（webhook 失靈當天，客人最壞等到隔天凌晨才被扶正——急件走本節步驟 2 手動觸發），和**本來就該人工裁決的錢務問題**——金額不符（§2，永不自動修）、email 永久錯誤（§4）、重複扣款／退款（§5／§6）、付款失敗後重試付款（T66/T74 生命週期範圍，尚未做）。
